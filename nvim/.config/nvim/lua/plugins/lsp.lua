    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gre', require('telescope.builtin').lsp_references, '[G]oto [R]eferences')
      ...
      -- NOTE: The `handlers` option allows you to define how each of the installed server is configured with nvim-lspconfig.
        handlers = {
